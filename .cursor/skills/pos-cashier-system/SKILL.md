...
Система маскировки админ-панели под интерфейс кассира магазина. Экран блокировки выглядит как рабочее место кассира, но поле "Поиск товаров" на самом деле принимает пароль для входа в CRM.
