...
2. Определить риск задачи: малый, обычный или высокий.
...
5. На готовой зафиксированной версии запускать независимые UX- и code-review проверки параллельно, если нужны обе.
6. Исправлять подтверждённые замечания одним пакетом и повторять только затронутую проверку.
7. Полную сборку и полный подходящий набор тестов запускать один раз перед сдачей или выпуском.
