      ...
      <div class="w-full max-w-3xl rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div v-else-if="activeWriteOff" class="space-y-6">
          <div class="flex justify-end gap-3">
            <button
              class="rounded-md border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-100"
              @click="startEditFromDetails"
            >
              Редактировать
            </button>
            <button
              class="rounded-md border border-red-200 px-4 py-2 text-sm font-medium text-red-600 transition hover:bg-red-50"
