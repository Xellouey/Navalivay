      ...
      >
        <section class="rules-modal-card">
          ...
          <div class="rules-modal-copy">
            ...
            <p>
              Каждая покупка добавляет один штамп в соответствующую категорию. Когда карта
              заполнится — вы получите скидку на следующую покупку.
            </p>
            <p>В одном заказе можно применить по одной бонусной скидке на каждую бонусную категорию.</p>
            <p>Обратите внимание: штампы начисляются только на товары без акций и промокодов.</p>
          </div>
